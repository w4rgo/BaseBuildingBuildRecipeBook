...
class Build_Recipe_Dialog
{
    ...
    class Controls
    {
        ...
        class ShowButton: RscButton
        {
            ...
            action = "closeDialog 0;_nil=[]ExecVM 'tweaks\player_build.sqf'";
        };
        ...
        {
            idc = 1207;
            text = "\z\addons\dayz_equip\textures\equip_toolbox_CA.paa"
        ...
        {
            idc = 1208;
            text = "\z\addons\dayz_equip\textures\equip_etool_CA.paa"
